...
noTint();
   ...
   ////pantalla final/////
    ...
    fill(255,alphaP1);
    textSize(12);
    text("representan una legendaria misión de exploración de 5 años por el siglo XXIII. Bajo el mando del capitán James T. Kirk, la tripulación se adentra en lo desconocido para cartografiar sectores y contactar nuevas civilizaciones.  (click en cualquier zona para volver)", 75,yAnim + 45,500,90);
    noTint();
     }
 }
